...
class UpdatesControllerTest < ActionController::TestCase
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post :create, update: { body: @update.body, goal_id: @update.goal_id, title: @update.title, user_id: @update.user_id }
    end
  ...
  test "should update update" do
    put :update, id: @update, update: { body: @update.body, goal_id: @update.goal_id, title: @update.title, user_id: @update.user_id }
    assert_redirected_to update_path(assigns(:update))
  end
